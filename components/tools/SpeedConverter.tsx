...
type SpeedUnit = 'kmh' | 'mph' | 'ms' | 'knots';

const UNITS: { value: SpeedUnit; label: string; factor: number }[] = [
  { value: 'kmh', label: 'Kilometers/hour (km/h)', factor: 1 },
  { value: 'mph', label: 'Miles/hour (mph)', factor: 1.60934 },
  { value: 'ms', label: 'Meters/second (m/s)', factor: 3.6 },
  { value: 'knots', label: 'Knots', factor: 1.852 },
];
