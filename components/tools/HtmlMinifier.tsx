  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300">HTML Input</label>
        <textarea
          value={input}
      ...
      {output && (
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-zinc-500">Basic minification: removes comments and whitespace. Complex HTML may need additional processing.</p>
        </div>
      )}
    </div>
  );
